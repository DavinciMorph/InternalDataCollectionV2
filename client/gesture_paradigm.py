...
GESTURES = ["Open", "Close", "Pinch", "KeyGrip"]
...
GESTURE_VIDEOS = {
    ...
    "Close":   os.path.join(_VIDEO_DIR, "IMG_5481.mp4"),
...
METHODOLOGIES = {
    1: MethodologyDef(
        ...
        instruction_text=(
            ...
            "The four gestures are: Open (spread fingers), Close (make a fist), "
            "Pinch (thumb to index finger), and Key Grip (thumb against side "
            "of index finger).\n\n"
    ...
    2: MethodologyDef(
        ...
        instruction_text=(
            ...
            "still.\n\n"
            "The four gestures are: Open, Close, Pinch, and Key Grip."
        ),
...
def compute_session_defaults(methodology_id: int, iti: float = DEFAULT_ITI_S):
    ...
    total_trials = max(4, (total_trials // 4) * 4)
    trials_per_gesture = total_trials // len(GESTURES)
...
class ConfigScreen(QWidget):
    ...
    def _build_ui(self):
        ...
        self.host_edit.setText("10.42.0.1")
